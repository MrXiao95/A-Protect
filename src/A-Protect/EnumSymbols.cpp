								...
								PVOID     Context)
{
	...
	NtosFuncAddressInfo->NtosFuncInfo[FuncCount].ulAddress =(ULONG) psi->Address;
	...
	PVOID     Context)
{
	...
	FuncAddressInfo->NtosFuncInfo[FuncCount].ulAddress = (ULONG)psi->Address;
...
Next:
	...
	for (int i=0;i<(int)FuncAddressInfo->ulCount;i++)
	{
