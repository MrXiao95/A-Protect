...
VOID FixFixTcp(PTCPDISPATCHBAKUP TcpDispatchBakUp,PDRIVER_OBJECT PTcpDriverObject,int i,ULONG ulReal_Dispatch,WCHAR *lpwzDispatchName,ULONG Dispatch)
{
	...
	ulCurrentTcpDispatch = (ULONG)PTcpDriverObject->MajorFunction[Dispatch];
	...
	if (ulCurrentTcpDispatch == ulReal_Dispatch)
	{
		...
		//检查是否inline hook
		if (GetFunctionCodeSize((PVOID)ulReal_Dispatch) == GetFunctionCodeSize((PVOID)ulReloadTcpDispatch) &&
			memcmp((PVOID)ulReal_Dispatch,(PVOID)ulReloadTcpDispatch,GetFunctionCodeSize((PVOID)ulReal_Dispatch)) != 0)
		{
			...
			if (!MmIsAddressValidEx((PVOID)ulCurrentTcpDispatch))
			{
...
VOID SetTcpHook(ULONG ulNumber,ULONG ulRealDispatch)
{
	...
	if (MmIsAddressValidEx(PTcpDriverObjectBakup))
	{
		...
		PTcpDriverObject->MajorFunction[ulNumber] = (PDRIVER_DISPATCH)ulRealDispatch;   //恢复 fsd hook
...
NTSTATUS ReLoadTcpip(PDRIVER_OBJECT DriverObject,PTCPDISPATCHBAKUP TcpDispatchBakUp,int Type)
{
	...
	if (GetDriverObject(L"\\Driver\\Tcpip",&PTcpipDriverObject) == STATUS_SUCCESS)
	{
		...
		if (GetDriverEntryPoint((PVOID)ulReLoadTcpipModuleBase,&TcpDriverEntry))
		{
			WinVer = GetWindowsVersion();
			switch (WinVer)
			{
			...
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CREATE] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_CREATE - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CREATE_NAMED_PIPE] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_CREATE_NAMED_PIPE - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CLOSE] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_CLOSE - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_READ] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_READ - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_WRITE] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_WRITE - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_INFORMATION] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_QUERY_INFORMATION - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_INFORMATION] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_SET_INFORMATION - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_EA] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_QUERY_EA - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_EA] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_SET_EA - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_FLUSH_BUFFERS] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_FLUSH_BUFFERS - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_VOLUME_INFORMATION] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_QUERY_VOLUME_INFORMATION - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_VOLUME_INFORMATION] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_SET_VOLUME_INFORMATION - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_DIRECTORY_CONTROL] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_DIRECTORY_CONTROL - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_FILE_SYSTEM_CONTROL] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_FILE_SYSTEM_CONTROL - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_DEVICE_CONTROL] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_DEVICE_CONTROL - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SHUTDOWN] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_SHUTDOWN - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_LOCK_CONTROL] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_LOCK_CONTROL - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CLEANUP] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_CLEANUP - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CREATE_MAILSLOT] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_CREATE_MAILSLOT - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_SECURITY] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_QUERY_SECURITY - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_SECURITY] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_SET_SECURITY - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_POWER] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_POWER - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SYSTEM_CONTROL] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_SYSTEM_CONTROL - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_DEVICE_CHANGE] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_DEVICE_CHANGE - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_QUOTA] =(PDRIVER_DISPATCH)( ulReal_TCP_IRP_MJ_QUERY_QUOTA - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_QUOTA] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_SET_QUOTA - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_PNP_POWER] = (PDRIVER_DISPATCH)(ulReal_TCP_IRP_MJ_PNP_POWER - ulTcpipModuleBase + ulReLoadTcpipModuleBase);
		}
	}
	return STATUS_SUCCESS;
}
NTSTATUS ReLoadTcpipFree()
{
	...
	if (MmIsAddressValidEx(PTcpDriverObjectBakup))
	{
		...
		{
			//恢复
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CREATE] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_CREATE;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CREATE_NAMED_PIPE] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_CREATE_NAMED_PIPE;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CLOSE] =(PDRIVER_DISPATCH) ulReal_TCP_IRP_MJ_CLOSE;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_READ] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_READ;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_WRITE] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_WRITE;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_INFORMATION] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_QUERY_INFORMATION;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_INFORMATION] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_SET_INFORMATION;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_EA] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_QUERY_EA;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_EA] =(PDRIVER_DISPATCH) ulReal_TCP_IRP_MJ_SET_EA;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_FLUSH_BUFFERS] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_FLUSH_BUFFERS;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_VOLUME_INFORMATION] =(PDRIVER_DISPATCH) ulReal_TCP_IRP_MJ_QUERY_VOLUME_INFORMATION;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_VOLUME_INFORMATION] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_SET_VOLUME_INFORMATION;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_DIRECTORY_CONTROL] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_DIRECTORY_CONTROL;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_FILE_SYSTEM_CONTROL] =(PDRIVER_DISPATCH) ulReal_TCP_IRP_MJ_FILE_SYSTEM_CONTROL;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_DEVICE_CONTROL] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_DEVICE_CONTROL;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SHUTDOWN] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_SHUTDOWN;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_LOCK_CONTROL] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_LOCK_CONTROL;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CLEANUP] =(PDRIVER_DISPATCH) ulReal_TCP_IRP_MJ_CLEANUP;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_CREATE_MAILSLOT] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_CREATE_MAILSLOT;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_SECURITY] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_QUERY_SECURITY;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_SECURITY] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_SET_SECURITY;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_POWER] =(PDRIVER_DISPATCH) ulReal_TCP_IRP_MJ_POWER;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SYSTEM_CONTROL] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_SYSTEM_CONTROL;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_DEVICE_CHANGE] = (PDRIVER_DISPATCH)ulReal_TCP_IRP_MJ_DEVICE_CHANGE;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_QUERY_QUOTA] =(PDRIVER_DISPATCH) ulReal_TCP_IRP_MJ_QUERY_QUOTA;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_SET_QUOTA] =(PDRIVER_DISPATCH) ulReal_TCP_IRP_MJ_SET_QUOTA;
			PTcpDriverObjectBakup->MajorFunction[IRP_MJ_PNP_POWER] =(PDRIVER_DISPATCH) ulReal_TCP_IRP_MJ_PNP_POWER;
		}
