...
extern BOOL g_bKernelSafeModule;  //内核安全模式
...
BOOL g_bKernelSafeModule = FALSE;  //内核安全模式，默认关闭
...
PEPROCESS g_protectEProcess;  //A盾自己进程的eprocess
...
NTSTATUS DisableDriverLoading();  //禁止加载驱动
