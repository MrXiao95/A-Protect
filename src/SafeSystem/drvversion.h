...
#define DRV_YEAR               2013 // current year or timespan (e.g. 2003-2009)
...
#define TEXT_MODULE            SafeSystem // module name
...
#define TEXT_INTERNALNAME      SafeSystem.sys // copyright information
